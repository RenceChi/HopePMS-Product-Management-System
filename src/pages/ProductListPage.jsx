...
// ── Temporary stubs — replace when PR-02 modals are ready ──
const AddProductModal = ({ onClose }) => null;
const EditProductModal = ({ onClose }) => null;
const SoftDeleteConfirmDialog = ({ onClose }) => null;
const PriceHistoryPanel = ({ onClose }) => null;
